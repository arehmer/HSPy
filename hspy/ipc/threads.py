...
class I2C(WThread_R1):
    """
    Class for running I2C driver in a thread.
    """
    ...
    def __init__(self,
        ...
        # Set I2C driver as attribute
        self.i2c_driver = i2c_driver
        
        # Assign the write buffer as output queue to the driver class, so 
        # it puts its data in there
        self.i2c_driver.output_queue = write_buffer
    ...
    def _target_function(self):
        ...
        try:
            # Try to assemble a frame from the udp packages
            frame = self.i2c.read_continuous_bytestream(self.DevID)
